...
-- Dumping data for table arc_db.arc_cmd_table: ~122 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `arc_sys_settings` (
  ...
  `set_op_bulk1` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `set_op_bulk2` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  PRIMARY KEY (`set_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table arc_db.arc_sys_settings: ~2 rows (approximately)
