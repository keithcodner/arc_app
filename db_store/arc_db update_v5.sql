...
-- Dumping database structure for pearlatl_arc
CREATE DATABASE IF NOT EXISTS `pearlatl_arc` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `pearlatl_arc`;


-- Dumping structure for table pearlatl_arc.arc_cmd_lst_table
...
-- Dumping data for table pearlatl_arc.arc_cmd_lst_table: ~11 rows (approximately)
...
-- Dumping structure for table pearlatl_arc.arc_cmd_table
...
-- Dumping data for table pearlatl_arc.arc_cmd_table: ~122 rows (approximately)
...
-- Dumping structure for table pearlatl_arc.arc_ctrl_table
...
-- Dumping data for table pearlatl_arc.arc_ctrl_table: ~6 rows (approximately)
...
-- Dumping structure for table pearlatl_arc.arc_c_usr_table
...
-- Dumping data for table pearlatl_arc.arc_c_usr_table: ~8 rows (approximately)
...
-- Dumping structure for table pearlatl_arc.arc_r_usr_table
...
-- Dumping data for table pearlatl_arc.arc_r_usr_table: ~7 rows (approximately)
...
-- Dumping structure for table pearlatl_arc.arc_sys_settings
...
-- Dumping data for table pearlatl_arc.arc_sys_settings: ~2 rows (approximately)
