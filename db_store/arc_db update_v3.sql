...
CREATE TABLE IF NOT EXISTS `arc_sys_settings` (
  ...
  `set_op1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `set_op2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `set_op3` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `set_op4` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `set_op5` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `set_op_bulk1` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `set_op_bulk2` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`set_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
